import { Group, AnimationMixer, Clock, SphereGeometry, Mesh, MeshBasicMaterial} from 'three';
...
class Bubble extends Group {
    ...
    constructor(parent: SeedScene) {
        ...
        //scene.add( sphere );
        this.position.z = Math.floor(Math.random() * parent.state.center * 2 - parent.state.center);
        this.state = {
            sphere: sphere,
            clock: new Clock(),
